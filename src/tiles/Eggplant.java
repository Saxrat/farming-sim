...
public class Eggplant extends Plant{
	...
	public Eggplant(float x, float y, PApplet p) {
		super(x, y, p);
		seedname = "../Assets/eggplantseeds.png";
		seedlingname = "../Assets/eggplantseedling.png";
		juvenilename = "../Assets/eggplantjuvenile.png";
		floweringname = "../Assets/eggplantflowering.png";
		immaturename = "../Assets/eggplantimmature.png";
		maturename = "../Assets/eggplantmature.png";
